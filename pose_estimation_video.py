...
cap = cv2.VideoCapture("./test videos/run1.mp4")
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            mp_drawing.draw_landmarks(
                ...
                mp_drawing.DrawingSpec(color=(0, 255, 0), thickness=2, circle_radius=2),  # Landmark drawing spec (Green)
                mp_drawing.DrawingSpec(color=(0, 0, 255), thickness=2, circle_radius=2)   # Connection drawing spec (Red)
            )
